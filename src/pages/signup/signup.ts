...
export class SignupPage {
   ...
   constructor(
    ...
    public alertCtrl: AlertController) {
      ...
      this.formGroup = this.formBuilder.group({ //Mesmo atributos do formulario com o backand
        ...
        email: ['Fernanda@gmail.com', [Validators.required, Validators.email]],
        ...
        telefone1 : ['996150767', [Validators.required]],
        telefone2 : ['', []],
        telefone3 : ['', []],
  ...
  signupUser() {
   // console.log("this.formGroup.value"); teste para verificar se estava enviando o formulario
